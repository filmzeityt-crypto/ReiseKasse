...
(function () {
  ...
  function renderList(s) {
    ...
    var entries = s.expenses.filter(function (e) {
      ...
      if (ui.categoryFilter && (e.kind === "settlement" || e.category !== ui.categoryFilter)) return false;
      if (!q) return true;
    ...
    if (!entries.length) {
      ...
      rows = groups.map(function (date) {
        ...
        var dayTotal = 0;
        dayEntries.forEach(function (e) { if (e.kind !== "settlement" && !e.reimbursed) dayTotal += R.convertExpense(e); });
        var wd = "";
        ...
        if (colorDays && dayTotal > 0) {
          if (dayTotal > avgRef) { totalCls = " day-high"; totalMark = "▲ "; }
          else { totalCls = " day-low"; totalMark = "▼ "; }
        }
  ...
  function renderSettingsModal(s) {
    ...
    return modalShell("Einstellungen",
      ...
      '<div class="hint" style="text-align:center;margin-top:2px">TripCash · Version 31</div>'
    );
  }
