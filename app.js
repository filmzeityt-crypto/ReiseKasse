...
(function () {
  ...
  function computeDerived(personFilter, includeReimbursed) {
    ...
    if (state.trip.startDate || firstEntry) {
      ...
      var end = state.trip.endDate ? new Date(state.trip.endDate + "T12:00:00") : new Date();
      var last = lastEntry ? new Date(lastEntry + "T12:00:00") : end;
      var cutoff = last < end ? last : end;   // keine Zukunftstage mitzählen
