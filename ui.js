...
(function () {
  ...
  function renderSettingsModal(s) {
    ...
    return modalShell("Einstellungen",
      ...
      '<div class="hint" style="text-align:center;margin-top:2px">TripCash · Version 21</div>'
    );
  }
  ...
  function renderHome(s) {
    ...
    if (!sums.length) {
      cards = '<div class="stub empty-hint">Noch keine Reise — leg unten deine erste an oder tritt mit einem Code bei.</div>';
    }
    ...
    return '<div class="app-header">' +
      ...
      '<div class="hint" id="t-join-hint">Beim allerersten Mal den kompletten Link nutzen, danach reicht der kurze Code.</div></div>' +
      "</div>";
  }
