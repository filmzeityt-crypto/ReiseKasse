...
(function () {
  ...
  function render() {
    ...
    if (ui.view === "home") {
      appEl.innerHTML = renderHome(s) + (ui.photoView ? renderPhotoViewer(s) : "");
      bindEvents(s);
      return;
    }
    appEl.innerHTML =
  ...
  function renderSettingsModal(s) {
    ...
    return modalShell("Einstellungen",
      ...
      '<div class="hint" style="text-align:center;margin-top:2px">TripCash · Version 15</div>'
    );
  }
  ...
  function renderHome(s) {
    ...
    return '<div class="app-header">' +
      ...
      '<div class="sub">TripCash</div></div></div>' +
      "</div>" +
      '<div class="app-main" style="padding-bottom:24px">' +
      cards +
      '<div class="stub" style="margin-top:6px"><div class="section-title display">Neue Reise</div>' +
  ...
  window.ReisekasseUI = { init: render, rerender: render, rerenderStatus: rerenderStatus, setView: function (v) { ui.view = v; render(); } };
})();
